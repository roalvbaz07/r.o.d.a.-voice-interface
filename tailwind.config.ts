  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        roda: {
          cyan: "hsl(var(--roda-cyan))",
          purple: "hsl(var(--roda-purple))",
          green: "hsl(var(--roda-green))",
        },
        sidebar: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 30px hsl(var(--roda-purple) / 0.4)" },
          "50%": { boxShadow: "0 0 60px hsl(var(--roda-purple) / 0.6)" },
        },
      },
      animation: {
